...
class UiStates():
    ...
    def setUiState(self):
        ...
        self.collapseFrame0 = mc.frameLayout('layout_Settings',     query=True, cl=0)
        self.collapseFrame1 = mc.frameLayout('layout_Mover',        query=True, cl=0)
        self.collapseFrame2 = mc.frameLayout('layout_Scaler',       query=True, cl=0)
        self.collapseFrame3 = mc.frameLayout('layout_Ratio',        query=True, cl=0)
        self.collapseFrame4 = mc.frameLayout('layout_Straighten',   query=True, cl=0)
        self.collapseFrame5 = mc.frameLayout('layout_Align',        query=True, cl=0)
        self.collapseFrame6 = mc.frameLayout('layout_QuickSnap',    query=True, cl=0)
        self.collapseFrame7 = mc.frameLayout('layout_MatchUV',      query=True, cl=0)
        self.collapseFrame8 = mc.frameLayout('layout_SelectionSets',query=True, cl=0)
